<div class="min-h-screen bg-gray-50 flex items-center justify-center p-4 sm:p-8 font-sans"
    x-data="{
            ...
            <form wire:submit.prevent="next" class="flex-1 flex flex-col justify-between h-full">
                ...
                <div class="mt-12 flex items-center justify-end border-t border-gray-100 pt-6">
                    <button type="submit" 
                         ...
                         <span wire:loading.remove wire:target="next" class="flex items-center gap-2">
